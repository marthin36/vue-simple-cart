      ...
      <b-container>
        ...
        <b-row>
          <b-col v-for="product in products" :key="product.id">
            ...
            <b-button v-if="!product.cart" @click="add(product)" href="#" variant="primary">Add to Shopping </b-button>
            <b-button v-if="product.cart" @click="add(product)" :disabled="product.cart" href="#" variant="warning">Product addded to Shopping Cart </b-button>
            </b-card>
              </b-col>
...
<b-row v-if="cart.length>0">
    ...
    <b-col></b-col>
    <b-col cols="4">Salvand asdasdasd </b-col>
    ...
    <b-modal hide-header-close no-close-on no-close-on-backdropd ref="modal-1" centered title="Purchase Completed" >
